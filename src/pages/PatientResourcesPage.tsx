    ...
    return (
        ...
        >
            ...
            <motion.div variants={STAGGER_CHILD_VARIANTS} className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
                ...
                {/* AI Helper Callout */}
                <div onClick={() => navigate('/chatbot')} className="flex items-center gap-4 bg-gradient-to-r from-primary-50 to-indigo-50 border border-primary-100/50 p-4 rounded-2xl cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all group">
